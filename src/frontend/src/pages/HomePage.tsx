...
export default function HomePage({
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Create Course CTA — only for logged-in users */}
      <AnimatePresence>
        {isLoggedIn && (
          <motion.section
            key="create-cta"
          ...
          >
            ...
            <div className="relative max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm mt-0.5">
                    Create your course in minutes — add videos, PDFs, and let AI
              ...
              >
                <Button
                  data-ocid="home.create_course_button"
                  onClick={() => onNavigate("create-course")}
                  size="lg"
                  className="h-12 px-8 font-bold text-base rounded-xl shadow-lg gap-2 border border-white/20"
                  style={{
      ...
      <section
        data-ocid="home.create_course_section"
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          >
            ...
            <p className="text-white/80 text-lg mb-6 leading-relaxed">
              Share your knowledge with the world — create a free course in
              minutes and reach thousands of eager learners.
            </p>
            <div className="flex flex-wrap gap-4 text-white/70 text-sm">
              {["Free to publish", "AI-powered quizzes", "Instant reach"].map(
                (f) => (
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center shadow-2xl">
              ...
              <p className="text-white/60 text-sm mb-6">
                Join thousands of educators already on EduAI
              </p>
              <Button
                data-ocid="home.create_course_cta_button"
                size="lg"
                className="w-full font-semibold text-base shadow-lg hover:scale-105 transition-transform"
                style={{
                  background: theme.accentColor,
                  color: "#fff",
                  border: "none",
                ...
                onClick={() =>
                  isLoggedIn ? onNavigate("create-course") : onNavigate("auth")
                }
              >
                {isLoggedIn ? "Create a Course" : "Sign In to Start Creating"}
              </Button>
              {!isLoggedIn && (
                <p className="text-white/50 text-xs mt-3">It&#39;s 100% free</p>
              )}
            </div>
          </motion.div>
        </div>
