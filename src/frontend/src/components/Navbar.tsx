          ...
          <div className="flex items-center gap-3">
            {isLoggedIn && (
              <button
                ...
                className="hidden md:flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-white transition-all duration-200 hover:scale-105 active:scale-95"
                style={{
                  background: `linear-gradient(135deg, ${theme.primaryColor}, ${theme.primaryColor}cc)`,
                  boxShadow: `0 0 18px -3px ${theme.primaryColor}88, 0 2px 8px rgba(0,0,0,0.25)`,
                }}
              >
